...
<section class="mainSection">
    ...
    <div class="buttonSection">
        ...
        <div class="button button--homepage "><a href="myWork.php" class="nostyle">Portfolio</a></div>
        <div class="button button--homepage "><a href="contact.php" class="nostyle">Contact Me</a></div>
    </div>
</section>
<?php
